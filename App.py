...
def ComprimirPDF(arquivoComprimir):
   ...
   os.system("tar -xvzf /app/streamlit-ferramentaspdf/pdfsizeopt_libexec_linux.tar.gz -C ./pdfsizeopt")
   ...
   os.system("dir /app/streamlit-ferramentaspdf/pdfsizeopt/pdfsizeopt")
